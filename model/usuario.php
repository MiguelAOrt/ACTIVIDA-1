  ...
  class Usuario extends Conexion
  {
    ...
    public function login($user, $clave)
    {
      /*
        ...
        llamar al metodo conectar de la clase pariente en este caso conexion xd
      ...
      */
      ...
      $consulta = 'select id, cargo from usuario where correo="'.$user.'" and clave= "'.$clave.'"';
      ...
      if($verificar_usuario > 0){
        ...
        */
        ...
        if($_SESSION['cargo'] == 1){
          ...
          echo "el usuario se ha logueado";
    ...
    public function registroUsuario($name, $apellido, $ciudad, $telefono, $email, $clave, $identificacion, $cargo)
    {
      parent::conectar();
      ...
      $clave = parent::filtrar($clave);
      $identificacion = parent::filtrar($identificacion);
      ...
      if($verificarCorreo > 0){
        ...
        parent::query('insert into estudiante(nombre, apellido, identificacion, ciudad, telefono ) value("'.$name.'", "'.$apellido.'", "'.$identificacion.'", "'.$ciudad.'", "'.$telefono.'")');
        parent::query('insert into usuario(correo, clave, cargo) values("'.$email.'", "'.$clave.'", "'.$cargo.'")');
